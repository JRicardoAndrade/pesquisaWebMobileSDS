...
const BASE_URL = 'http://192.168.0.181:8080';
...
const CreateRecord = () =>{
    ...
    const handleChangePlatform = (selectedPlatfrom: GamePlatform) => {
        setPlatform(selectedPlatfrom);
        const gamesByPlatform = allGames.filter(
            game => game.platform === selectedPlatfrom
        )
    ...
    const handleSubmit = () =>{
        ...
        .catch(() => Alert.alert('Erro o salvar informações'));
    }
